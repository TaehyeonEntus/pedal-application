...
class BoardTest {
    ...
    void GetPedals() throws Exception {
        ...
        Pedal pedal1 = Pedal.create("fuzz", "찌지직", category);
        Pedal pedal2 = Pedal.create("tube screamer", "우에엥", category);
    ...
    void MovePedal() throws Exception {
        ...
        Pedal pedal3 = Pedal.create("페달3","설명3", category);
        pedalRepository.save(pedal3);

        Pedal pedal4 = Pedal.create("페달4","설명4", category);
        pedalRepository.save(pedal4);

        Pedal pedal5 = Pedal.create("페달5","설명5", category);
